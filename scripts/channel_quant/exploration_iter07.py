...
def main():
    ...
    for w1f, w2f, label in [
        (0.02, 0.08, "outlier_w1_2_w2_8"),
        (0.03, 0.07, "outlier_w1_3_w2_7"),
        (0.01, 0.09, "outlier_w1_1_w2_9"),
        (0.05, 0.05, "outlier_5pct_uniform"),
        (0.02, 0.10, "outlier_w1_2_w2_10"),
        (0.00, 0.10, "outlier_w2_only_10"),
        (0.00, 0.15, "outlier_w2_only_15"),
        (0.05, 0.10, "outlier_w1_5_w2_10"),
        (0.10, 0.10, "outlier_w1_10_w2_10"),
        (0.03, 0.12, "outlier_w1_3_w2_12"),
    ]:
        w1m, w2m = build_topk_masks(metric_cache, text_config, w1f, w2f)
        plan = make_plan(label, f"W1={int(w1f*100)}% W2={int(w2f*100)}% FP8 outlier channels",
    ...
    payload = {
        "metadata": {"model": MODEL_ID, "eval_tokens": EVAL_TOKENS, "calib_tokens": CALIB_TOKENS,
                      "note": "Iteration 7: push outlier approach with per-projection split"},
        "results": results,
    }
    out_path = Path(__file__).parent / "results" / "exploration_iter07.json"
