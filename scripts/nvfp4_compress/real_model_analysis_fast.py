#!/usr/bin/env python3
"""Step 1: Real Model Evaluation (Fast Version).
...
def main():
    print("=" * 70)
    print("STEP 1: REAL MODEL EVALUATION (FAST)")
    print("=" * 70)
    ...
    # Analyze first 5 tensors only (for speed)
    fp4_tensors = fp4_tensors[:5]
