...
Compares Phase 7 (Per-Layer Codebooks) against Phase 6 (Adaptive Scaling)
"""
...
def compare_phase6_vs_phase7() -> Dict:
    """Compare Phase 6 (Adaptive) vs Phase 7 (Per-Layer Codebooks)."""
    logger.info("=" * 80)
    logger.info("PHASE 7: VALIDATION AND COMPARISON")
    logger.info("=" * 80)
    ...
    logger.info(f"\nPhase 6 Baseline (Adaptive Scaling):")
    ...
    logger.info(f"\nPhase 7 Results (Per-Layer Codebooks):")
...
if __name__ == "__main__":
    results = compare_phase6_vs_phase7()
    
    # Save results
    output_file = "phase7_validation_comparison_results.json"
