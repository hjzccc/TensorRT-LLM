#!/usr/bin/env python3
"""
Phase 18A: Activation-Weighted MSE Codebook Selection (FIXED)
...
class ActivationWeightedCodebookSelector:
    ...
    def code_to_value(self, code_idx: int) -> float:
        """Convert code index to FP4 value."""
        return self.fp4_codes[code_idx]
    ...
    def compute_activation_weights(
        ...
        Args:
            block_codes: 1D array of code indices (0-15)
        ...
        for i, code_idx in enumerate(block_codes):
            ...
            if activation_data is not None:
                ...
                # Fallback: weight by magnitude of the FP4 value
    ...
    def compute_activation_weighted_mse(
        ...
        Weighted MSE = Σ_i weight[code_i] × (value_i - quantized_i)²
        
        Args:
            block_codes: 1D array of code indices (0-15)
            subset_indices: Tuple of 4 code indices for the subset
            weights: Activation weight array
    ...
    def select_codebook_exact_mse(
        ...
        for subset_indices in self.all_subsets:
            mse = self.compute_exact_mse(block_codes, subset_indices)
    ...
    def select_codebook_activation_weighted(
        ...
        for subset_indices in self.all_subsets:
            mse = self.compute_activation_weighted_mse(block_codes, subset_indices, weights)
...
def test_on_synthetic_data():
    ...
    test_cases = [
        {
            ...
            'codes': np.random.randint(0, 16, size=128),
            'activation': None,
        },
        {
    ...
    for test_case in test_cases:
        ...
        block = test_case['codes'].astype(np.int32)
...
if __name__ == '__main__':
    print("\n" + "="*80)
    print("PHASE 18A: ACTIVATION-WEIGHTED MSE CODEBOOK SELECTION (FIXED)")
    print("="*80)
