#!/usr/bin/env python3
"""Compress full model with residual codebook + adaptive scaling + entropy coding.

Applies entropy coding to all 120 weights in Qwen3.5-35B-A3B.
...
def main():
    """Compress full model."""
    print("=" * 80)
    print("FULL MODEL ENTROPY CODING COMPRESSION")
    print("=" * 80)
